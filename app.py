...
if destination:
    ...
    2. 선택한 식당들의 대표 메뉴, 특징, 평점, 영업시간을 너의 지식을 총동원해서 친절한 한국어로 설명해줘.
    3. 만약 특정 식당의 정확한 평점이나 영업시간을 알 수 없다면 가짜로 지어내지 말고 "정보 없음" 또는 "포털 확인 필요"라고 솔직하게 적어줘.

    [출력 양식]
    아래 양식을 지켜서 보기 좋게 출력해줘. (마크다운 문법 적용 가능)

    ### 🍴 [식당 이름]
    * **⭐ 예상 평점:** (예: 4.5/5.0 또는 포털 확인 필요)
    * **⏰ 영업 시간:** (예: 11:30 ~ 22:00 또는 정보 없음)
    * **📌 대표 메뉴:** (주요 메뉴 이름 적기)
    * **💬 한 줄 평:** (식당의 특징과 분위기를 살린 친절한 설명)
